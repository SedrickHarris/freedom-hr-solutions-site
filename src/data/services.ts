...
export const services: Service[] = [
  // ---------- HR Compliance & Risk ----------
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-hr-mri-risk-assessment-editorial-service-image.webp",
  ...
  },
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-compliance-support-editorial-service-image.webp",
      alt: "Compliance support",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-compliance-support-service-hero.webp",
      alt: "HR compliance support consulting",
    },
    hubSlug: "hr-compliance",
    launch: true,
  ...
  },
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-employee-handbook-creation-management-editorial-service-image.webp",
      alt: "Employee handbook creation management",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-employee-handbook-creation-management-service-hero.webp",
      alt: "Employee handbook creation and management",
    },
    hubSlug: "hr-compliance",
    launch: true,
  ...
  },
  {
    ...
    heroImage: {
      src: "/images/services/freedom-hr-solutions-workforce-compliance-monitoring-service-hero.webp",
      alt: "Workforce compliance monitoring",
    },
    hubSlug: "hr-compliance",
  ...
  // ---------- ACA Reporting & Compliance ----------
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-aca-reporting-consultant-editorial-service-image.webp",
      alt: "ACA reporting consultant",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-aca-reporting-consultant-service-hero.webp",
      alt: "ACA reporting consultant",
    },
  ...
  },
  {
    ...
    heroImage: {
      src: "/images/services/freedom-hr-solutions-aca-compliance-review-service-hero.webp",
      alt: "ACA compliance review",
    },
    hubSlug: "aca-reporting-compliance",
  ...
  },
  {
    ...
    heroImage: {
      src: "/images/services/freedom-hr-solutions-applicable-large-employer-review-service-hero.webp",
      alt: "Applicable large employer review",
    },
    hubSlug: "aca-reporting-compliance",
  ...
  // ---------- Payroll, Benefits & HR Systems ----------
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-payroll-benefits-hr-management-editorial-service-image.webp",
      alt: "Payroll benefits HR management",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-payroll-benefits-hr-management-service-hero.webp",
      alt: "Payroll benefits and HR management",
    },
  ...
  },
  {
    ...
    heroImage: {
      src: "/images/services/freedom-hr-solutions-benefits-administration-support-service-hero.webp",
      alt: "Benefits administration support",
    },
    hubSlug: "payroll-benefits-hr-systems",
  ...
  },
  {
    ...
    heroImage: {
      src: "/images/services/freedom-hr-solutions-multi-state-payroll-support-service-hero.webp",
      alt: "Multi-state payroll support",
    },
    hubSlug: "payroll-benefits-hr-systems",
  ...
  // ---------- HR Technology & Automation ----------
  {
    ...
    meta: {
      title: "HR Technology and Automation Consulting | Freedom HR Solutions",
      description:
    ...
    summary:
      "Automate repetitive workflows, connect your HR and payroll systems, and improve the reporting your team depends on.",
    intro:
    ...
    problems: [
      ...
      "HR and payroll systems do not share data cleanly.",
      "Reports are hard to build, hard to trust, and slow to produce.",
      "Technology investments are not delivering the value they promised.",
    ],
    includes: [
      { title: "Workflow automation", description: "Identify and automate repetitive HR, payroll, and benefits tasks to reduce manual effort and errors." },
      { title: "System integration", description: "Connect HR, payroll, and benefits platforms so data flows cleanly without duplicate entry." },
      { title: "Process improvement", description: "Streamline the workflows that slow your team down and document the improvements so they stick." },
      { title: "Reporting and visibility", description: "Build reports and dashboards that give leaders clear, reliable visibility into workforce data." },
    ],
    whoItHelps: ["HR teams", "Growing businesses", "Payroll teams", "Multi-state employers", "Business owners"],
    challenges: [
      "Manual data entry and rekeying across systems",
      "Disconnected HR, payroll, and benefits platforms",
      "Weak, manual, or inconsistent reporting",
      "Implementations that stalled before delivering value",
    ],
    process: standardProcess,
    benefits: [
      { title: "Less manual work", description: "Automated workflows free your team from repetitive tasks and reduce avoidable errors." },
      { title: "Connected systems", description: "Cleaner data flow between platforms means less rekeying and more reliable records." },
      { title: "Better reporting", description: "Dashboards and reports your leadership team can actually use and rely on." },
      { title: "More value from existing technology", description: "Get full use out of the systems you already pay for rather than working around them." },
    ],
    ...
    faqs: [
      { question: "What is HR technology and automation consulting?", answer: "HR technology and automation consulting is hands-on help choosing, connecting, configuring, and improving the systems that run your HR, payroll, and benefits operations so your team spends less time on manual work." },
      { question: "Which HR workflows can be automated?", answer: "Onboarding steps, approval routing, data updates, reporting generation, and parts of payroll and benefits workflows are commonly automated. The right targets depend on your current systems and where manual effort is highest." },
      { question: "Can Freedom HR Solutions help connect HR and payroll systems?", answer: "Yes. We review your current platforms and integration options and help configure or improve the connections so data flows more cleanly between systems." },
      { question: "Can HR automation help reduce payroll and benefits errors?", answer: "Often yes. Automating manual steps reduces the opportunities for rekeying errors and inconsistent data across platforms." },
      { question: "Can Freedom HR Solutions help improve HR reporting?", answer: "Yes. We help build reports and dashboards that give leaders clearer visibility into workforce costs, trends, and performance without requiring manual data assembly each time." },
      { question: "Do we need to switch systems to benefit from HR technology consulting?", answer: "Not necessarily. Many improvements come from better configuration and use of the platforms you already have. We evaluate what you have in place before recommending any changes." },
    ],
    platformSlugs: [
  ...
  },
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-system-setup-implementation-editorial-service-image.webp",
      alt: "System setup implementation",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-system-setup-implementation-service-hero.webp",
      alt: "HR system setup and implementation",
    },
    hubSlug: "hr-technology-automation",
    launch: true,
  ...
  },
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-hris-implementation-editorial-service-image.webp",
      alt: "HRIS implementation",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-hris-implementation-service-hero.webp",
      alt: "HRIS implementation",
    },
    hubSlug: "hr-technology-automation",
    launch: true,
  ...
  },
  {
    ...
    heroImage: {
      src: "/images/services/freedom-hr-solutions-streamlining-processes-service-hero.webp",
      alt: "Streamlining HR processes",
    },
    hubSlug: "hr-technology-automation",
  ...
  },
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-reporting-data-insights-editorial-service-image.webp",
      alt: "Reporting data insights",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-reporting-data-insights-service-hero.webp",
      alt: "HR reporting and data insights",
    },
    hubSlug: "hr-technology-automation",
    launch: true,
    ...
    meta: {
      title: "HR Reporting and Data Insights | Freedom HR Solutions",
      description:
        "Freedom HR Solutions helps HR, payroll, and benefits teams build reports, dashboards, and data insights that give leaders clear visibility into costs, trends, and workforce performance. Serving businesses in Las Vegas, Nevada, and nationwide.",
    },
    summary:
      "Turn scattered HR and payroll data into clear reports and dashboards leaders can act on.",
    intro:
      "Good decisions start with good data. Freedom HR Solutions helps HR teams, payroll managers, and business leaders turn scattered workforce data into organized reports and dashboards they can actually act on. Whether you need better visibility into payroll costs, headcount trends, benefits utilization, or compliance status, we work inside your existing HR and payroll systems to build reporting that fits how your team operates. We also help clean up the underlying data so the numbers your leaders see are accurate and trustworthy.",
    problems: [
      "Reports take too long to build and are often out of date.",
      "Leaders lack clear visibility into payroll costs and workforce trends.",
      "Data is inconsistent across HR and payroll systems.",
      "Reporting errors undermine trust in the numbers.",
      "Key metrics are tracked in spreadsheets instead of the system.",
      "No one knows which reports to run or how to interpret them.",
    ],
    includes: [
      { title: "Payroll and workforce reporting", description: "Build reports that track payroll costs, headcount, turnover, and workforce trends over time." },
      { title: "Benefits and compliance reporting", description: "Bring benefits enrollment, utilization, and compliance data into clear, trackable reports." },
      { title: "Dashboards and visibility tools", description: "Create dashboards that give HR and leadership ongoing visibility into key workforce metrics." },
      { title: "HR KPI tracking", description: "Define and track the HR metrics that matter most to your business: headcount, turnover, cost per hire, and more." },
      { title: "Data cleanup and accuracy", description: "Improve the underlying data in your HR and payroll systems so reports are reliable and consistent." },
      { title: "Custom report builds", description: "Build custom reports tailored to the questions your leaders need answered, using your existing systems." },
    ],
    ...
    relatedServiceSlugs: ["system-audits-improvements", "hr-technology-automation", "payroll-benefits-hr-management", "system-setup-implementation", "ongoing-technical-support"],
    relatedAudienceSlugs: ["hr-teams", "payroll-teams", "growing-businesses"],
    faqs: [
      { question: "What is HR reporting and data insights support?", answer: "HR reporting and data insights support means helping businesses build the reports, dashboards, and data structures that give leaders clear visibility into workforce costs, headcount, benefits utilization, and compliance status. Freedom HR Solutions works inside your existing systems to improve reporting accuracy and reduce manual report-building." },
      { question: "What HR reports should a business track?", answer: "Common reports include payroll costs by department, headcount and turnover, benefits enrollment and utilization, time and attendance trends, and compliance status. We help you identify which reports matter most for your business and build them inside your existing HR and payroll systems." },
      { question: "Can Freedom HR Solutions build custom HR reports?", answer: "Yes. We help build custom reports tailored to the questions your leaders need answered, using the HR and payroll systems you already have. We do not require new software unless your current systems cannot support the reporting you need." },
      { question: "What HR KPIs and metrics should a business monitor?", answer: "Common HR KPIs include headcount, turnover rate, time to fill, cost per hire, benefits participation rate, and payroll cost as a percentage of revenue. We help you define the metrics that fit your business and set up tracking inside your existing systems." },
      { question: "Can benefits data be included in HR dashboards?", answer: "Yes. We help bring benefits enrollment, utilization, and compliance data into your reporting and dashboards so HR and leadership have a complete picture of workforce costs and program participation." },
      { question: "Can reporting help with compliance reviews?", answer: "Yes. Organized, accurate reporting makes it easier to review compliance status, prepare documentation, and respond to questions from auditors or leadership. Better data visibility supports better compliance awareness." },
      { question: "Can Freedom HR Solutions help clean up HR data reporting errors?", answer: "Yes. We help identify the root cause of reporting errors, whether that is inconsistent data entry, system configuration gaps, or misaligned fields, and work to improve the underlying data so your reports are more reliable over time." },
    ],
    primaryCta: ctas.techReview,
    secondaryCta: exploreSupport,
  },
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-system-audits-improvements-editorial-service-image.webp",
      alt: "System audits improvements",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-system-audits-improvements-service-hero.webp",
      alt: "HR system audits and improvements",
    },
    hubSlug: "hr-technology-automation",
    launch: true,
    ...
    meta: {
      title: "HR System Audit and Improvement Services | Freedom HR Solutions",
      description:
        "Freedom HR Solutions audits HR, payroll, and benefits system settings, data, workflows, and reporting to find configuration gaps, recurring errors, and improvement opportunities.",
    },
    summary:
      "A structured review of your HR, payroll, and benefits systems to find configuration gaps, recurring errors, and workflow problems before they cause larger issues.",
    intro:
      "HR, payroll, and benefits systems change constantly. New employees, plan updates, payroll adjustments, and system upgrades all touch configurations that were set up a certain way for a reason that no one quite remembers anymore. Over time, those changes accumulate into drift: settings that no longer match how the business operates, reports that do not reconcile, and errors that keep coming back without a clear explanation. Freedom HR Solutions conducts structured audits of your HR, payroll, and benefits systems to surface what is misconfigured, what is missing, and what can be improved. The result is a prioritized plan you can act on, not just a list of things that are wrong.",
    problems: [
      "Recurring payroll or benefits errors that keep coming back after being fixed.",
      "System settings that were configured during implementation and never revisited.",
      "Reports that do not match what leaders see in other systems or expect to see.",
      "No one on the team has a clear picture of how the system is actually configured.",
    ],
    includes: [
      { title: "Configuration review", description: "Check system settings, rules, and logic against how your business actually operates to identify gaps and mismatches." },
      { title: "Data and reporting review", description: "Review data quality and reporting outputs to surface inconsistencies that affect accuracy and decision-making." },
      { title: "Workflow and integration review", description: "Identify gaps, bottlenecks, and broken handoffs in how data and tasks move between your HR, payroll, and benefits systems." },
      { title: "Prioritized improvement plan", description: "Deliver a clear, actionable list of findings ranked by impact so your team knows what to address first." },
    ],
    whoItHelps: ["Growing businesses", "HR teams", "Payroll teams", "Multi-state employers"],
    challenges: [
      "Configuration drift over time",
      "Recurring errors without a clear cause",
      "Reporting that does not match reality",
      "Workflow gaps and integration breakdowns",
    ],
    process: standardProcess,
    benefits: [
      { title: "Root-cause clarity", description: "Understand why errors keep occurring instead of patching the same problem repeatedly." },
      { title: "Accurate system configuration", description: "Settings that reflect how your business actually operates, not how it operated at implementation." },
      { title: "Reliable reporting", description: "Data outputs that match across systems so leaders can trust what they are looking at." },
      { title: "A clear improvement roadmap", description: "Prioritized recommendations your team can act on in a logical sequence." },
    ],
    relatedServiceSlugs: ["hr-technology-automation", "system-setup-implementation", "technical-issue-resolution", "reporting-data-insights", "ongoing-technical-support"],
    relatedAudienceSlugs: ["growing-businesses", "hr-teams", "payroll-teams"],
    faqs: [
      { question: "What is an HR system audit?", answer: "An HR system audit is a structured review of your HR, payroll, and benefits system settings, data quality, workflows, and reporting to identify configuration gaps, recurring errors, and opportunities for improvement. The output is typically a prioritized list of findings and recommended fixes." },
      { question: "When should a business audit its HR or payroll system?", answer: "An audit is most useful after a major change such as a system implementation, a significant headcount increase, or an expansion into new states. It is also worth conducting when errors keep recurring, reports do not reconcile, or no one is confident the system is configured correctly." },
      { question: "What does an HR system audit include?", answer: "A typical HR system audit covers configuration settings, eligibility and payroll rules, data quality, reporting outputs, workflow logic, and system integrations. The review looks for mismatches between how the system is set up and how the business actually operates." },
      { question: "Can Freedom HR Solutions help find the cause of recurring payroll errors?", answer: "Yes. Recurring payroll errors often trace back to a specific configuration setting, payroll rule, or data entry pattern. We review the underlying setup to identify the source so the issue can be corrected rather than patched repeatedly." },
      { question: "Can Freedom HR Solutions review HR system integrations?", answer: "Yes. We review how your HR, payroll, and benefits systems connect and where data handoffs break down so information flows more cleanly between platforms." },
      { question: "What happens after the audit is complete?", answer: "You receive a prioritized improvement plan with findings organized by impact. We can help implement the recommended changes or work alongside your team as you address them." },
    ],
    primaryCta: ctas.systemReview,
    secondaryCta: ctas.consultation,
  },
  ...
  // ---------- Support & Service Continuity ----------
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-ongoing-technical-support-editorial-service-image.webp",
      alt: "Ongoing technical support",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-ongoing-technical-support-service-hero.webp",
      alt: "Ongoing HR technical support",
    },
    ...
    meta: {
      title: "Ongoing HR and Payroll Technical Support | Freedom HR Solutions",
      description:
        "Freedom HR Solutions provides ongoing technical support for HR, payroll, and benefits systems, including troubleshooting, system updates, monitoring, and continuous improvements. Serving businesses in Las Vegas, Nevada, and nationwide.",
    },
    summary:
      "A reliable resource for troubleshooting, updates, and improvements to your HR, payroll, and benefits systems over time.",
    intro:
      "HR, payroll, and benefits systems need ongoing attention to stay reliable. Configurations drift as policies change, issues surface after open enrollment, and small problems pile up when no one has bandwidth to address them. Freedom HR Solutions provides ongoing technical support so your team always has a knowledgeable resource to turn to, whether the need is a quick question, a recurring issue that needs root-cause work, a system update that needs to be applied correctly, or a periodic review to catch problems before they affect payroll or benefits.",
    problems: [
      "Issues pile up because no one on the team has time to address them.",
      "System configurations drift as policies, plans, and staff change.",
      "Updates and system changes are hard to keep up with.",
      "Small problems go unaddressed until they affect payroll or benefits.",
      "The team lacks a reliable resource for HR and payroll system questions.",
      "There is no proactive process to catch issues before they escalate.",
    ],
    includes: [
      { title: "Troubleshooting and issue resolution", description: "Diagnose and resolve HR, payroll, and benefits system issues as they come up." },
      { title: "System updates and configuration maintenance", description: "Keep configurations current as your systems, plans, and business requirements change." },
      { title: "Monitoring and proactive checks", description: "Periodic reviews to catch configuration gaps, data issues, and workflow problems before they escalate." },
      { title: "Post-implementation support", description: "Ongoing help after a new system goes live so the initial setup continues to deliver value." },
      { title: "Continuous process improvements", description: "Identify and implement refinements to HR, payroll, and benefits workflows over time." },
      { title: "Platform-agnostic support", description: "Support delivered across the HR and payroll systems your team already uses, including ADP, isolved, BambooHR, and others." },
    ],
    ...
    relatedServiceSlugs: ["technical-issue-resolution", "system-audits-improvements", "open-enrollment-setup", "hr-technology-automation", "reporting-data-insights"],
    relatedAudienceSlugs: ["payroll-teams", "benefits-administrators", "hr-teams"],
    faqs: [
      { question: "What does ongoing HR and payroll technical support include?", answer: "Ongoing HR and payroll technical support includes troubleshooting system issues, keeping configurations current, performing periodic reviews to catch problems early, and making continuous improvements to HR, payroll, and benefits workflows as your business changes." },
      { question: "Can Freedom HR Solutions provide support after a system goes live?", answer: "Yes. Post-implementation support is one of the most common reasons businesses work with us on an ongoing basis. After go-live, systems need maintenance, configurations need updating, and issues arise that were not visible during implementation." },
      { question: "Can ongoing support help prevent payroll errors?", answer: "Yes. Proactive configuration reviews and monitoring help catch issues before they affect payroll processing. When errors do occur, having an ongoing support relationship means faster diagnosis and resolution." },
      { question: "Can Freedom HR Solutions support the HR and payroll systems we already use?", answer: "Yes. We provide support across the platforms your team already uses, including ADP, isolved, BambooHR, HiBob, and other HR and payroll systems. We do not require you to change platforms to work with us." },
      { question: "Can ongoing support include benefits system maintenance?", answer: "Yes. Support can span HR, payroll, and benefits systems, including benefits configuration updates, open enrollment preparation, and eligibility rule maintenance." },
      { question: "What is the difference between ongoing technical support and technical issue resolution?", answer: "Ongoing technical support is a continuing relationship that covers routine maintenance, monitoring, and improvements over time. Technical issue resolution is focused on diagnosing and correcting a specific urgent or recurring error. Both services are available and can work together." },
      { question: "Can Freedom HR Solutions provide HR support for small businesses without an HR department?", answer: "Yes. Ongoing technical support is particularly useful for small businesses that do not have a dedicated HR team. It gives you a reliable external resource for system questions, troubleshooting, and maintenance without the cost of a full-time hire." },
    ],
  ...
  },
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-technical-issue-resolution-editorial-service-image.webp",
      alt: "Technical issue resolution",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-technical-issue-resolution-service-hero.webp",
      alt: "HR technical issue resolution",
    },
    hubSlug: "support-service-continuity",
    launch: true,
    ...
    meta: {
      title: "HR and Payroll Technical Issue Resolution | Freedom HR Solutions",
      description:
        "Freedom HR Solutions helps diagnose and resolve urgent or recurring HR, payroll, and benefits system errors, configuration issues, data sync failures, and integration problems. Serving businesses in Las Vegas, Nevada, and nationwide.",
    },
    summary:
      "Root-cause diagnosis and correction for urgent or recurring HR, payroll, and benefits system issues.",
    intro:
      "When something breaks in payroll or benefits, you need it fixed at the source, not patched around. Freedom HR Solutions helps diagnose the root cause of HR, payroll, and benefits system errors, correct the underlying configuration or data issue, validate that the fix works, and put steps in place to prevent it from happening again. Whether the problem is a recurring payroll calculation error, a benefits configuration that is not behaving correctly, a data sync failure between systems, or an integration that has stopped working, we work through it methodically and document what was done.",
    problems: [
      "An urgent payroll or benefits error is affecting employees.",
      "The same issue keeps coming back after being patched.",
      "Data is not syncing correctly between HR and payroll systems.",
      "No one can identify the actual root cause of the problem.",
      "A benefits configuration is producing incorrect eligibility results.",
      "An integration between systems has stopped working.",
    ],
    includes: [
      { title: "Root-cause analysis", description: "Diagnose the real source of the problem, not just the visible symptom." },
      { title: "Payroll error resolution", description: "Identify and correct payroll calculation, configuration, and data errors." },
      { title: "Benefits configuration fixes", description: "Resolve benefits plan setup, eligibility, and enrollment configuration issues." },
      { title: "Data sync and integration repair", description: "Address failures in data flow between HR, payroll, and benefits systems." },
      { title: "Testing and validation", description: "Confirm the fix works correctly before considering the issue closed." },
      { title: "Prevention recommendations", description: "Document what caused the issue and recommend steps to keep it from recurring." },
    ],
    ...
    relatedServiceSlugs: ["ongoing-technical-support", "system-audits-improvements", "payroll-benefits-hr-management", "system-setup-implementation", "reporting-data-insights"],
    relatedAudienceSlugs: ["payroll-teams", "benefits-administrators", "hr-teams"],
    faqs: [
      { question: "What is HR and payroll technical issue resolution?", answer: "It is the process of diagnosing the root cause of an error or system problem, correcting it at the source, validating that the fix works, and recommending steps to prevent recurrence. Freedom HR Solutions provides this support for HR, payroll, and benefits systems." },
      { question: "Can Freedom HR Solutions help troubleshoot payroll system errors?", answer: "Yes. We help identify the root cause of payroll calculation, configuration, and data errors, correct the underlying issue, and validate the fix before the engagement closes." },
      { question: "Can Freedom HR Solutions help resolve recurring HR or payroll errors?", answer: "Yes. Recurring errors usually point to a configuration issue or a data problem that has not been addressed at the source. We focus on root-cause diagnosis so the issue is less likely to return after correction." },
      { question: "Can Freedom HR Solutions fix a benefits configuration error?", answer: "Yes. We help diagnose and correct benefits plan setup, eligibility rules, and enrollment configuration issues inside your existing HR or benefits system." },
      { question: "Can Freedom HR Solutions help with data sync failures between HR and payroll systems?", answer: "Yes. We help identify where the data flow has broken down, work to restore correct syncing, and recommend configuration or process changes to prevent the failure from recurring." },
      { question: "Can Freedom HR Solutions coordinate with our HR or payroll software provider?", answer: "Yes. We frequently work alongside your software provider during issue resolution. We help document the problem, communicate technical details, and validate the fix once the provider applies it." },
      { question: "How is a resolved technical issue documented?", answer: "We document the issue, the root cause identified, the correction applied, the validation steps taken, and any recommendations for preventing recurrence. That record stays with your team." },
    ],
    primaryCta: ctas.technicalSupport,
    secondaryCta: ctas.consultation,
  },
  {
    ...
    image: {
      src: "/images/services/freedom-hr-solutions-open-enrollment-setup-editorial-service-image.webp",
      alt: "Open enrollment setup",
    },
    heroImage: {
      src: "/images/services/freedom-hr-solutions-open-enrollment-setup-service-hero.webp",
      alt: "Open enrollment setup",
    },
    hubSlug: "support-service-continuity",
    launch: true,
    title: "Open Enrollment Setup",
    h1: "Open Enrollment Setup and Benefits Configuration Support",
    meta: {
      title: "Open Enrollment Setup and Benefits Configuration Support | Freedom HR Solutions",
      description:
        "Freedom HR Solutions helps employers prepare for open enrollment with benefits plan configuration, system setup, employee communication support, testing, and post-enrollment reconciliation.",
    },
    summary:
      "Plan configuration, system setup, employee communication, testing, and reconciliation so open enrollment runs on time and without avoidable errors.",
    intro:
      "Open enrollment is one of the most time-compressed periods in HR. Benefits plans need to be configured, systems need to be tested, employees need clear information, and carrier data has to reconcile after the window closes. Freedom HR Solutions helps employers move through each stage of open enrollment with a structured approach so the process is organized before it opens and accurate after it closes. We work in your existing systems and alongside your team so setup does not fall entirely on one person.",
    problems: [
      "Open enrollment preparation competes with daily HR and payroll work.",
      "Benefits plan configurations contain errors that are not caught until employees start enrolling.",
      "Employees do not understand their options and communication arrives too late to help.",
      "Post-enrollment reconciliation is disorganized and carrier data does not match system records.",
    ],
    includes: [
      { title: "Benefits plan configuration", description: "Set up plan options, eligibility rules, rates, and enrollment logic in your HR or benefits system before the window opens." },
      { title: "System testing and quality review", description: "Test enrollment settings end to end so configuration errors are identified and corrected before employees start making elections." },
      { title: "Employee communication support", description: "Help structure timely, clear communication about plan options, deadlines, and changes so employees can make informed decisions." },
      { title: "Post-enrollment reconciliation", description: "Reconcile elections against payroll deductions and carrier data after the window closes so records are accurate going into the new plan year." },
    ],
    whoItHelps: ["Benefits administrators", "HR teams", "Small and growing businesses", "Multi-state employers"],
    challenges: [
      "Tight enrollment timelines",
      "Benefits configuration errors",
      "Employee communication gaps",
      "Post-enrollment data discrepancies",
    ],
    process: standardProcess,
    benefits: [
      { title: "Organized enrollment season", description: "A structured preparation process so setup is complete and tested before the window opens." },
      { title: "Fewer configuration errors", description: "Settings verified through testing rather than discovered through employee complaints." },
      { title: "Clearer employee communication", description: "Employees who receive timely, plain-language information about their options and deadlines." },
      { title: "Accurate post-enrollment data", description: "Reconciled records that match across your HR system, payroll, and carrier files." },
    ],
    relatedServiceSlugs: ["benefits-administration-support", "payroll-benefits-hr-management", "aca-reporting-consultant", "technical-issue-resolution", "ongoing-technical-support"],
    relatedAudienceSlugs: ["benefits-administrators", "hr-teams", "multi-state-employers"],
    faqs: [
      { question: "What does open enrollment setup include?", answer: "Open enrollment setup typically includes benefits plan configuration, eligibility rule setup, system testing, employee communication support, and post-enrollment reconciliation. The goal is to have settings tested and communication ready before employees start making elections." },
      { question: "How early should open enrollment preparation start?", answer: "Most employers benefit from starting preparation four to six weeks before the enrollment window opens. This provides enough time to configure plans, complete testing, and get communication materials ready without rushing." },
      { question: "Can Freedom HR Solutions help configure benefits plans for open enrollment?", answer: "Yes. We help set up plan options, eligibility rules, rates, and enrollment logic in your existing HR or benefits system so configuration is accurate before employees begin making elections." },
      { question: "What should be tested before open enrollment opens?", answer: "Benefits plan settings, eligibility rules, enrollment workflows, and the employee-facing enrollment experience should all be tested before the window opens. Testing catches configuration errors before they affect employee elections." },
      { question: "Can Freedom HR Solutions help with employee communication during open enrollment?", answer: "Yes. We help structure enrollment communication so employees receive clear, timely information about their plan options, deadlines, and any changes from the prior year." },
      { question: "What happens after open enrollment closes?", answer: "After enrollment closes, elections need to be reconciled against payroll deductions and carrier data to confirm records are accurate for the new plan year. We help with this reconciliation so discrepancies are caught and corrected before they affect payroll or coverage." },
    ],
  ...
  // ---------- Talent & Workforce Development ----------
  {
    ...
    heroImage: {
      src: "/images/services/freedom-hr-solutions-recruiting-onboarding-solutions-service-hero.webp",
      alt: "Recruiting and onboarding solutions",
    },
  ...
  },
  {
    ...
    heroImage: {
      src: "/images/services/freedom-hr-solutions-training-development-programs-service-hero.webp",
      alt: "Training and development programs",
    },
    hubSlug: "talent-workforce-development",
  ...
  },
  {
    ...
    heroImage: {
      src: "/images/services/freedom-hr-solutions-employee-engagement-performance-management-service-hero.webp",
      alt: "Employee engagement and performance management",
    },
    hubSlug: "talent-workforce-development",
